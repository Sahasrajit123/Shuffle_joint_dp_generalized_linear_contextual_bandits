...
class GlmUCB:
    def __init__(self, arm_set, kappa, R, S, model, T, delta, do_proj=False, lazy_update_fr=5, rng=None):
        """
        ...
        self.theta_hat = self.rng.normal(0, 1, (self.dim,))
        self.theta_tilde = self.rng.normal(0, 1, (self.dim,))
        # self.ctr = 0
        # self.ucb_bonus = 0
        self.kappa = kappa
        self.R = R
