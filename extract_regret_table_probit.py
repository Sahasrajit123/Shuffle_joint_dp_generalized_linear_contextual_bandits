...
# S values to extract (excluding S=3.25)
...
for s in s_values:
    ...
    filename = f'Results/Extras_probit/experiment_probit_uniform_split_S_{s_str}.pickle'
...
# Create output file
output_file = 'regret_output_table_probit.txt'
with open(output_file, 'w') as f:
    f.write("=" * 80 + "\n")
    f.write("CUMULATIVE REGRET ACROSS DIFFERENT ALGORITHMS (PROBIT)\n")
    f.write("=" * 80 + "\n\n")
...
print("\n" + "=" * 80)
print("CUMULATIVE REGRET ACROSS DIFFERENT ALGORITHMS (PROBIT)")
print("=" * 80 + "\n")
